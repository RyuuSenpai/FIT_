...
//            return UIImage(named:"")
        case .Shirt:
            return UIImage(named:"img_shirt--short-sleeve")
        case .Polo_Shirt:
            return UIImage(named:"img_polo_t_shirt--short-sleeve")
        case .T_Shirt:
            return UIImage(named:"img_t_shirt--short-sleeve")
        case .Long_Sleeve_T_Shirt:
            return UIImage(named:"img_t_shirt--long-sleeve")
        default:
            return UIImage(named:"img_t_shirt--short-sleeve")
        }
    }
